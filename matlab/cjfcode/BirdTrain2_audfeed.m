%Version 1.0 of BirdTrain2_audfeed.m
...
function [networks,activation,LifeHistory]=BirdTrain2_audfeed(networks,activation,LifeHistory,duration,flag)
...
LifeHistory.Trainer='BirdTrain2_audfeed';
LifeHistory.TrainerSyl=(activation.current-11)/16;