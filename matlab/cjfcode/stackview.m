function varargout = stackview(varargin)
...
% Last Modified by GUIDE v2.5 15-Oct-2010 16:55:38
...
axes(handles.axes1);imagesc(handles.stack(:,:,1));colormap(gray);axis off;
guidata(hObject, handles);
handles.numim=size(handles.stack,3);
...
axes(handles.axes1);imagesc(handles.stack(:,:,Val));colormap(gray);axis off;
...
[threshIm,thresh]=MCTstack(handles.stack);
figure;plotSurface(threshIm,.5,[.5 .5 .5],[1 1 1],1);
