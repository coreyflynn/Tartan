%a=FourierVarAnalysis(pathbase,experimentbase,repeat_time,start,finish,file_label)

function a=FourierVarAnalysis(pathbase,experimentbase,repeat_time,start,finish,file_label)
